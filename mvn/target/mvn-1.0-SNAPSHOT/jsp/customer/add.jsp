					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
                        ...
                        <TABLE cellSpacing=0 cellPadding=5  border=0>
                            ...
                            <TR>
                                ...
                                <td>
                                    <INPUT class=textbox id="custPhone"
                                           style="WIDTH: 180px" maxLength=50 name="customerBasic.custPhone" value="${visitPhone}" <c:if test="${visitPhone ne null && visitPhone ne ''}"> readonly="readonly" </c:if> />
                                </td>
                                <td>客户信息来源 ：</td>
                                <td>
                            ...
                            <TR>
                                <td>客户简介 ：</td>
                                <td colspan="4">
									<textarea class=textbox id="customerDetail.custMemo"  style="OVERFLOW:hidden;width:400px;height:200px"
