								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer/add.action"
														target=main_frame>－ 新增客户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer/list.action"
														target=main_frame>－ 客户列表</A></TD>
												</TR>
								...
								<TR>
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/visit/add.action"
														target=main_frame>－ 新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/visit/list.action"
														target=main_frame>－ 客户拜访列表</A></TD>
												</TR>
											...
											<%--<TBODY>--%>
												<%--<TR>--%>
													<%--<TD class=menuSmall><A class=style2 href="#"--%>
														<%--target=main_frame>－ 客户信息查询</A></TD>--%>
												<%--</TR>--%>
												<%--<TR>--%>
													<%--<TD class=menuSmall><A class=style2 href="#"--%>
														<%--target=main_frame>－ 联系人信息查询</A></TD>--%>
												<%--</TR>--%>
												<%--<TR>--%>
													<%--<TD class=menuSmall><A class=style2 href="#"--%>
														<%--target=main_frame>－ 客户拜访记录查询</A></TD>--%>
												<%--</TR>--%>
											<%--</TBODY>--%>
										<%--</TABLE>--%>
									<%--</TD>--%>
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/statistic/dictStatistic.action?statisticTypeName=cust_source&statisticTypeCode=001"
														target=main_frame>－ 客户来源统计</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/statistic/dictStatistic.action?statisticTypeName=cust_industry&statisticTypeCode=002"
														target=main_frame>－ 客户行业统计</A></TD>
												</TR>
									...
									<%--<TD>--%>
										<%--<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0--%>
											...
											<%--<TBODY>--%>
												<%--<TR>--%>
													<%--<TD class=menuSmall><A class=style2 href="#"--%>
														<%--target=main_frame>－ 角色管理</A></TD>--%>
												<%--</TR>--%>
												<%--<TR>--%>
													<%--<TD class=menuSmall><A class=style2 href="#"--%>
														<%--target=main_frame>－ 用户管理</A></TD>--%>
												<%--</TR>--%>
												<%--<TR>--%>
													<%--<TD class=menuSmall><A class=style2 href="#"--%>
														<%--target=main_frame>－ 数据字典</A></TD>--%>
												<%--</TR>--%>
											<%--</TBODY>--%>
										<%--</TABLE>--%>
									<%--</TD>--%>
