...
<BODY>
	<FORM id=form1 name=form1 method=post action="${pageContext.request.contextPath }/login.action" target="_top">
													...
													<TBODY>
														<TR>
															...
															<TD style="HEIGHT: 28px" width=150>
																<INPUT id=txtName style="WIDTH: 130px" name="usercode"></TD>
														...
														<TR>
															...
															<TD style="HEIGHT: 28px"><INPUT id=txtPwd
																style="WIDTH: 130px" type=password name="pwd"></TD>
														...
														<TR>
															...
															<TD style="HEIGHT: 28px"><INPUT id=txtcode
																style="WIDTH: 60px" name="validatecode"> <img
																id="randomcode_img" src="${pageContext.request.contextPath}/validatecode.jsp"
																alt="" width="56" height="20" align='absMiddle' /></TD>
